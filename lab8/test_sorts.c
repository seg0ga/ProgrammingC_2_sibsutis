...
static void test_knuth_sequence(void **state) {
    (void)state;
    int seq[20], size;
...
static void test_insertion_sort(void **state) {
    (void)state;
    int arr[] = {5, 2, 4, 6, 1, 3};
...
static void test_shell_sort(void **state) {
    (void)state;
...
static void test_generate_array(void **state) {
    (void)state;
    int arr[100];
    int prev = -1;
